...
class cmd_git_commands(commandParent):
    '''
    ...
    def __init__(self, CMD, coms):
        ...
        self.__commandName = 'git_commands'
        self.__args ={
            "refresh_git" : self.refresh_git
        }
    ...
    def run_args(self, args):
        ...
        return message
    def refresh_git(self, _):
        '''
            Pulls the command packet repo. 
        '''
        repo_path = os.path.abspath("command_packets")
        ...
        dto = print_message_dto("Ran refresh_git")
        self.__coms.print_message(dto, 2)
        return "<p>ran command refresh_git<p>"
    def get_args(self):
        '''
    ...
    def get_args_server(self):
        ...
        for key in self.__args:
            ...
            'Description' : 'Refreshes the command packet repo'    
            })
        return message
